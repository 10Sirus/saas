...
const AboutSection = () => {
  // Define the type of the 'text' prop
  interface ListProps {
    text: string; // Change 'string' to the appropriate type if needed
  }

  // Destructure the 'text' prop from props and type it with ListProps
